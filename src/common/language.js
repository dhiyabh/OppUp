export default {
    ...
    notification_title:'VAMOS Notification',
    register:'Register',
    ...
    android_channel: 'VAMOS Notifications',
    ...
    not_valid_driver:'This is not a valid driver',
    driver_reached:'Your driver has reached pickup point',
    drive_to_pickup:'REACH PICKUP POINT',
    rider_is_waiting:'Rider is waiting for you.'
}